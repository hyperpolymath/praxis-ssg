...
image:https://img.shields.io/badge/license-AGPL--3.0-green[AGPL-3.0]

== Overview

doit-ssg is a satellite project that consumes SSG adapters from the https://github.com/hyperpolymath/poly-ssg-mcp[poly-ssg-mcp] hub, providing a unified interface to build static sites using any of 28 supported generators.
...
* https://github.com/hyperpolymath/doit-ssg/issues[GitHub Issues] - Bug reports
* https://github.com/hyperpolymath/doit-ssg/discussions[GitHub Discussions] - Questions
